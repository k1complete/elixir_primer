# -*- coding: utf-8 -*-
#
# elixi primer documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('.'))
extensions = ['japanesesupport', 'ext', 'その他の拡張']
...
project = u'elixi primer'
copyright = u'2013, @k1complete'
...
htmlhelp_basename = 'elixiprimerdoc'
...
latex_documents = [
  ('index', 'elixiprimer.tex', u'elixi primer Documentation',
   u'@k1complete', 'manual'),
]
...
man_pages = [
    ('index', 'elixiprimer', u'elixi primer Documentation',
     [u'@k1complete'], 1)
]
...
texinfo_documents = [
  ('index', 'elixiprimer', u'elixi primer Documentation',
   u'@k1complete', 'elixiprimer', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'elixi primer'
epub_author = u'@k1complete'
epub_publisher = u'@k1complete'
epub_copyright = u'2013, @k1complete'
